    ...
    public class ApplicationDbSeeder
    {
        ...
        private async Task SeedCategoriesAsync()
        {
            if (!_context.Categories.Any())
            {
                ...
                {
                    new Category { Name = "Electronics", Description = "Electronic gifts", IsActive = true },
                    new Category { Name = "Toys", Description = "Kids toys", IsActive = true },
                    new Category { Name = "Fashion", Description = "Clothing & accessories", IsActive = true }
                };
        ...
        private async Task SeedOccasionsAsync()
        {
            if (!_context.Occasions.Any())
            {
                ...
                {
                    new Occasion { Name = "Birthday", Description = "Birthday gifts", IsActive = true },
                    new Occasion { Name = "Wedding", Description = "Wedding gifts", IsActive = true },
                    new Occasion { Name = "Christmas", Description = "Christmas gifts", IsActive = true }
                };
        ...
        private async Task SeedProductsAsync()
        {
            if (!_context.Products.Any())
            {
                ...
                {
                    // Electronics
                    new Product { Name = "Smart Watch", Description = "Elegant smart watch with health tracking", Price = 299.99m, Stock = 50, CategoryId = electronics.Id, IsActive = true },
                    new Product { Name = "Wireless Earbuds", Description = "Premium noise cancelling earbuds", Price = 199.99m, Stock = 40, CategoryId = electronics.Id, IsActive = true },
                    new Product { Name = "Portable Speaker", Description = "Waterproof bluetooth speaker", Price = 149.99m, Stock = 35, CategoryId = electronics.Id, IsActive = true },
                    new Product { Name = "Smart Lamp", Description = "Color changing smart LED lamp", Price = 89.99m, Stock = 60, CategoryId = electronics.Id, IsActive = true },
                    new Product { Name = "Wireless Charger", Description = "Fast wireless charging pad", Price = 49.99m, Stock = 80, CategoryId = electronics.Id, IsActive = true },

                    // Toys
                    new Product { Name = "LEGO Set", Description = "Creative building blocks set", Price = 79.99m, Stock = 45, CategoryId = toys.Id, IsActive = true },
                    new Product { Name = "Remote Control Car", Description = "High speed RC car", Price = 59.99m, Stock = 30, CategoryId = toys.Id, IsActive = true },
                    new Product { Name = "Puzzle 1000pcs", Description = "Challenging landscape puzzle", Price = 29.99m, Stock = 55, CategoryId = toys.Id, IsActive = true },
                    new Product { Name = "Board Game", Description = "Fun family board game", Price = 39.99m, Stock = 25, CategoryId = toys.Id, IsActive = true },
                    new Product { Name = "Stuffed Animal", Description = "Super soft teddy bear", Price = 24.99m, Stock = 70, CategoryId = toys.Id, IsActive = true },

                    // Fashion
                    new Product { Name = "Perfume Set", Description = "Luxury perfume collection", Price = 150.00m, Stock = 30, CategoryId = fashion.Id, IsActive = true },
                    new Product { Name = "Silk Scarf", Description = "Premium silk scarf with floral print", Price = 89.99m, Stock = 40, CategoryId = fashion.Id, IsActive = true },
                    new Product { Name = "Leather Wallet", Description = "Genuine leather slim wallet", Price = 69.99m, Stock = 50, CategoryId = fashion.Id, IsActive = true },
                    new Product { Name = "Sunglasses", Description = "UV protection stylish sunglasses", Price = 119.99m, Stock = 35, CategoryId = fashion.Id, IsActive = true },
                    new Product { Name = "Watch Box", Description = "Elegant wooden watch display box", Price = 59.99m, Stock = 20, CategoryId = fashion.Id, IsActive = true },
                };
